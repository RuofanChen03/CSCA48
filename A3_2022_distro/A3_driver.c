...
#include<stdio.h>
#include<stdlib.h>
#include"ingredient_graphs_1008163719.c"
...
int main()
{
   ...
   for (int i=0; i<10; i++)
	...
	printf("\n ****** substituting ingredient 'quinoa' in recipe2\n");
   substitute_ingredient(recipe2,"quinoa");
   for (int i=0; i<10; i++)
 ...
 ****** Related to 'quinoa' k-dist, k=1 - Updated
sunflower seeds
artichoke hearts
